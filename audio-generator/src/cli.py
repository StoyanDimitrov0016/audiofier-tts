...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Turn a .md or .txt lesson into speech with Kokoro.")
    ...
    parser.add_argument("--voice", default=DEFAULT_VOICE, help="Kokoro voice name, e.g. af_heart")
    parser.add_argument("--speed", type=float, default=1.0, help="Speech speed, e.g. 0.95 or 1.05")
    parser.add_argument("--lang-code", default=DEFAULT_LANG_CODE, help="Kokoro language code")
    parser.add_argument("--repo-id", default=DEFAULT_REPO_ID, help="Model repo id")
